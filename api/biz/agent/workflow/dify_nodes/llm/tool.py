...
示例: [{'role': 'system', 'text': '你是一个专业的翻译家。'}, {'role': 'user', 'text': '将'{{#sys.query#}}'翻译成中文。'}]",
    ...
    title: Annotated[str, "节点的显示标题。默认为 '语言模型'。"] = "语言模型",
    model_provider: Annotated[
        str, "LLM模型的提供商。默认为 'langgenius/siliconflow/siliconflow'。"
    ] = "langgenius/siliconflow/siliconflow",
    model_name: Annotated[
        str, "LLM模型的具体名称。默认为 'deepseek-ai/DeepSeek-V3'。"
    ] = "deepseek-ai/DeepSeek-V3",
    temperature: Annotated[
        float, "控制生成文本的随机性 (0.0-2.0)。值越高越随机。默认为 0.7。"
    ] = 0.7,
    stop_sequences: Annotated[Optional[List[str]], "停止生成的序列列表。"] = None,
    desc: Annotated[
        str, "节点的可选描述信息。默认为 '执行语言模型推理'。"
    ] = "执行语言模型推理",
) -> Dict[str, Any]:
    """
