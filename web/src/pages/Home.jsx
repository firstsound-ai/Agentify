    ...
    featured: {
      ...
      prompts: [
        ...
        },
        {
          ...
          content: '设计一个个人日程管理应用，包含智能提醒、优先级排序和时间统计功能'
        },
        {
          title: '创意写作工具',
          description: '构建一个支持多种文体的AI写作助手',
          content: '构建一个创意写作工具，支持小说、诗歌、剧本等多种文体的创作辅助'
        },
        {
          title: '智能客服系统',
          description: '开发24小时在线的智能客户服务机器人',
          content: '开发一个智能客服系统，能够理解用户问题、提供准确答案并无缝转接人工客服'
        }
      ]
    },
    research: {
      ...
      prompts: [
        {
          ...
          content: '开发一个学术论文分析工具，能够自动提取关键信息、分析研究方法和总结结论'
        },
        {
          title: '数据挖掘平台',
        ...
        },
        {
          ...
          content: '构建一个文献综述助手，能够自动搜索相关文献并生成结构化综述报告'
        },
        {
          title: '实验数据管理',
          description: '设计科研实验数据收集和分析系统',
          content: '设计一个实验数据管理系统，支持数据采集、处理、分析和可视化展示'
        }
      ]
    },
    productivity: {
      ...
      prompts: [
        {
          ...
          content: '设计一个任务自动化管理系统，包含智能分配、进度跟踪和效率分析功能'
        },
        {
          title: '会议纪要生成',
          description: '开发自动生成会议总结和行动项的工具',
          content: '开发一个会议纪要自动生成工具，能够实时记录、总结要点并提取行动项'
        },
        {
          title: '邮件智能处理',
          description: '创建邮件自动分类和回复建议系统',
          content: '创建一个邮件智能处理系统，支持自动分类、优先级标记和回复建议生成'
        },
        {
          title: '知识库管理',
          description: '构建企业知识共享和检索平台',
          content: '构建一个企业知识库管理系统，支持文档自动分类、智能搜索和知识推荐'
        }
      ]
    },
    education: {
      ...
      prompts: [
        {
          ...
          content: '构建一个个性化学习平台，根据学习者特点生成定制化学习路径和内容推荐'
        },
        {
          title: '智能题库生成',
          description: '开发自动生成练习题和测验的教学工具',
          content: '开发一个智能题库系统，能够根据知识点自动生成不同难度的练习题和测验'
        },
        {
          title: '课程内容助手',
          description: '创建课程设计和教学内容生成工具',
          content: '创建一个课程内容助手，帮助教师设计课程结构、生成教学材料和评估方案'
        },
        {
          title: '学习进度跟踪',
          description: '开发学生学习行为分析和成绩预测系统',
          content: '开发一个学习进度跟踪系统，分析学生学习行为、预测学习效果并提供改进建议'
        }
      ]
    },
    data: {
      ...
      prompts: [
        ...
        },
        {
          ...
          content: '开发一个预测分析系统，基于历史数据进行趋势预测和业务洞察分析'
        },
        {
          title: '报表自动化',
          description: '创建定期报表生成和分发系统',
          content: '创建一个报表自动化系统，支持定时生成、格式化和自动分发各类业务报表'
        },
        {
          title: '数据质量监控',
          description: '建立数据质量检测和异常告警机制',
          content: '建立一个数据质量监控系统，实时检测数据异常、评估数据质量并自动生成告警'
        }
      ]
    }
  };
